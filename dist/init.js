...
var init = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(templateName, probjectName) {
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          loading.start();
                          (0, _get.downloadLocal)(templateName, probjectName).then(function () {
                            loading.succeed();
                            var fileName = probjectName + '/package.json';
                            if (_fs2.default.existsSync(fileName)) {
                              var data = _fs2.default.readdirSync(fileName).toString();
